...
| M2 | OCR engines behind one trait, UI Automation text source, layout analysis, language ID, CER benchmark | in progress (OCR trait, stub, CER benchmark, text sources with merge, layout analysis, language ID done; UI Automation source left) |
