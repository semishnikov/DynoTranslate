...
| M5 | Tauri shell wiring, onboarding, tray, hotkeys, region editor, full i18n, accessibility audit | done |
| M6 | Performance tuning, edge cases, chaos and soak runs, updater, installer | CI green; tag rehearsal left |
