...
static LA: Strokes = &[&[[16, 8], [14, 10], [8, 10], [4, 8], [4, 4], [6, 0], [12, 0], [16, 2]], &[[16, 10], [16, 0]]];
static LB: Strokes = &[&[[4, 14], [4, 0]], &[[4, 6], [6, 10], [12, 10], [16, 6], [16, 4], [12, 0], [6, 0], [4, 2]]];
static LC: Strokes = &[&[[16, 8], [12, 10], [6, 10], [4, 6], [4, 4], [6, 0], [12, 0], [16, 2]]];
static LD: Strokes = &[&[[16, 6], [14, 10], [8, 10], [4, 6], [4, 4], [8, 0], [14, 0], [16, 2]], &[[16, 14], [16, 0]]];
static LE: Strokes = &[&[[16, 6], [4, 6], [4, 8], [8, 10], [12, 10], [16, 8], [14, 2], [10, 0], [6, 0], [4, 2]]];
...
static LO: Strokes = &[&[[6, 10], [12, 10], [16, 6], [16, 4], [12, 0], [6, 0], [4, 4], [4, 6], [6, 10]]];
static LP: Strokes = &[&[[4, 14], [4, -4]], &[[4, 6], [6, 10], [12, 10], [16, 6], [16, 4], [12, 0], [6, 0], [4, 2]]];
static LQ: Strokes = &[&[[16, 6], [14, 10], [8, 10], [4, 6], [4, 4], [8, 0], [14, 0], [16, 2]], &[[16, 10], [16, -4]]];
static LR: Strokes = &[&[[4, 10], [4, 0]], &[[4, 6], [8, 10], [14, 10]]];
static LS: Strokes = &[&[[16, 8], [12, 10], [6, 10], [4, 8], [6, 6], [12, 4], [14, 2], [12, 0], [6, 0], [4, 2]]];
...
static L_O_UMLAUT: Strokes = &[
    &[[6, 13], [6, 13]],
    &[[12, 13], [12, 13]],
    &[[6, 10], [12, 10], [16, 6], [16, 4], [12, 0], [6, 0], [4, 4], [4, 6], [6, 10]],
];
...
static L_SHARP_S: Strokes = &[
    &[[6, -4], [6, 12], [10, 14], [14, 13], [14, 11], [10, 9], [14, 7], [14, 2], [10, 0], [8, 0]],
];
static L_OE: Strokes = &[
    &[[3, 10], [7, 10], [9, 8], [9, 2], [7, 0], [3, 0], [1, 2], [1, 8], [3, 10]],
    &[[19, 6], [11, 6], [11, 8], [14, 10], [17, 10], [19, 8], [18, 2], [15, 0], [12, 0], [11, 2]],
];
static L_E_GRAVE: Strokes = &[
    &[[8, 15], [12, 13]],
    &[[16, 6], [4, 6], [4, 8], [8, 10], [12, 10], [16, 8], [14, 2], [10, 0], [6, 0], [4, 2]],
];
static L_E_ACUTE: Strokes = &[
    &[[8, 13], [12, 15]],
    &[[16, 6], [4, 6], [4, 8], [8, 10], [12, 10], [16, 8], [14, 2], [10, 0], [6, 0], [4, 2]],
];
static L_U_GRAVE: Strokes = &[&[[8, 15], [12, 13]], &[[4, 10], [4, 2], [6, 0], [12, 0], [16, 2]], &[[16, 10], [16, 0]]];
...
static L_S_ACUTE: Strokes = &[
    &[[8, 13], [12, 15]],
    &[[16, 8], [12, 10], [6, 10], [4, 8], [6, 6], [12, 4], [14, 2], [12, 0], [6, 0], [4, 2]],
];
...
static L_R_CARON: Strokes = &[&[[4, 15], [8, 12], [12, 15]], &[[4, 10], [4, 0]], &[[4, 6], [8, 10], [14, 10]]];
...
static U_S_ACUTE: Strokes = &[
    &[[8, 17], [12, 18]],
    &[[16, 12], [12, 14], [7, 14], [4, 12], [6, 8], [12, 7], [15, 6], [16, 3], [13, 0], [7, 0], [4, 2]],
];
...
static UC: Strokes = &[&[[16, 12], [12, 14], [8, 14], [4, 11], [4, 3], [8, 0], [12, 0], [16, 2]]];
static UD: Strokes = &[&[[4, 0], [4, 14]], &[[4, 14], [10, 14], [16, 10], [16, 4], [10, 0], [4, 0]]];
static UE: Strokes = &[&[[16, 14], [4, 14], [4, 0], [16, 0]], &[[4, 7], [14, 7]]];
static UF: Strokes = &[&[[16, 14], [4, 14], [4, 0]], &[[4, 7], [14, 7]]];
static UG: Strokes = &[&[[16, 12], [12, 14], [8, 14], [4, 11], [4, 3], [8, 0], [12, 0], [16, 3], [16, 7], [11, 7]]];
...
static UO: Strokes = &[&[[7, 14], [14, 14], [18, 10], [18, 4], [14, 0], [7, 0], [4, 4], [4, 10], [7, 14]]];
static UP: Strokes = &[&[[4, 0], [4, 14]], &[[4, 14], [12, 14], [16, 12], [16, 8], [12, 6], [4, 6]]];
static UQ: Strokes = &[
    &[[7, 14], [14, 14], [18, 10], [18, 4], [14, 0], [7, 0], [4, 4], [4, 10], [7, 14]],
    &[[13, 4], [18, -2]],
];
static UR: Strokes = &[
    &[[4, 0], [4, 14]],
...
static D0: Strokes = &[&[[7, 14], [14, 14], [18, 10], [18, 4], [14, 0], [7, 0], [4, 4], [4, 10], [7, 14]]];
static D1: Strokes = &[&[[6, 10], [11, 14], [11, 0]]];
static D2: Strokes = &[&[[4, 12], [7, 14], [13, 14], [16, 11], [16, 9], [4, 0], [16, 0]]];
static D3: Strokes = &[&[[4, 14], [14, 14], [8, 8], [14, 8], [16, 6], [16, 2], [13, 0], [7, 0], [4, 2]]];
static D4: Strokes = &[&[[14, 0], [14, 14], [4, 5], [18, 5]]];
static D5: Strokes = &[&[[16, 14], [6, 14], [5, 8], [11, 8], [16, 6], [16, 2], [13, 0], [7, 0], [4, 2]]];
static D6: Strokes = &[
    &[[15, 13], [12, 14], [8, 14], [4, 10], [4, 2], [7, 0], [13, 0], [16, 2], [16, 6], [13, 8], [4, 8]],
];
static D7: Strokes = &[&[[4, 14], [16, 14], [8, 0]]];
static D8: Strokes = &[
    &[[10, 14], [6, 14], [4, 12], [4, 10], [7, 8], [13, 8], [16, 10], [16, 12], [14, 14], [10, 14]],
    &[[7, 8], [4, 6], [4, 2], [7, 0], [13, 0], [16, 2], [16, 6], [13, 8]],
];
static D9: Strokes = &[
    &[[5, 1], [8, 0], [12, 0], [16, 4], [16, 12], [13, 14], [7, 14], [4, 12], [4, 8], [7, 6], [16, 6]],
];
...
static PQUEST: Strokes = &[&[[4, 12], [7, 14], [13, 14], [16, 12], [16, 10], [10, 7], [10, 5]], &[[10, 1], [10, 1]]];
...
static CZE: Strokes = &[
    &[[4, 9], [8, 10], [13, 10], [15, 8], [15, 7], [10, 6], [15, 5], [15, 2], [13, 0], [8, 0], [4, 1]],
];
static CI: Strokes = &[&[[4, 10], [4, 0]], &[[4, 0], [16, 10]], &[[16, 10], [16, 0]]];
static CJI: Strokes = &[&[[7, 14], [10, 12], [13, 14]], &[[4, 10], [4, 0]], &[[4, 0], [16, 10]], &[[16, 10], [16, 0]]];
...
static CF: Strokes = &[
    &[[10, 14], [10, -4]],
    &[[6, 8], [14, 8], [16, 6], [16, 2], [14, 0], [6, 0], [4, 2], [4, 6], [6, 8]],
];
...
static CSCH: Strokes = &[&[[4, 10], [4, 0], [16, 0], [16, 10]], &[[10, 10], [10, 0]], &[[16, 0], [18, -4]]];
...
static CSOFT: Strokes = &[&[[4, 10], [4, 0]], &[[4, 4], [10, 4], [12, 3], [11, 1], [7, 0], [4, 0]]];
static CEREV: Strokes = &[&[[4, 8], [8, 10], [13, 10], [16, 7], [16, 3], [13, 0], [8, 0], [4, 2]], &[[9, 5], [16, 5]]];
static CYU: Strokes = &[
    &[[4, 0], [4, 10]],
    &[[4, 5], [9, 5]],
    &[[10, 7], [13, 10], [17, 8], [18, 5], [17, 2], [13, 0], [10, 2], [9, 5], [10, 7]],
];
static CYA: Strokes = &[
    &[[16, 0], [16, 10]],
...
static CE_UKR: Strokes = &[&[[4, 6], [16, 6], [16, 8], [12, 10], [8, 10], [4, 8], [6, 2], [10, 0], [14, 0], [16, 2]]];
...
static CSHB: Strokes = &[&[[4, 0], [4, 14]], &[[11, 0], [11, 14]], &[[18, 0], [18, 14]], &[[4, 14], [18, 14]]];
